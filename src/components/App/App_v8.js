...
import { useLoadPages } from '../../hooks/useLoadFirstPage';
...
export default function App() {
  ...
  console.log('firstPageData.length', firstPageData?.Search?.length);
  console.log('isFetching', firstPageIsFetching);
  console.log('firstPageError', firstPageError);
